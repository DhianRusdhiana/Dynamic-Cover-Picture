...
public class KenBurnsView extends FrameLayout {
    ...
    private void swapImage() {
        ...
        mActiveImageIndex = (3 + mActiveImageIndex) % mImageViews.length;
    ...
    protected void onFinishInflate() {
        ...
        View view = inflate(getContext(), getID("view_dynamic_cover","layout"), this);
        
        mImageViews = new ImageView[4];
        mImageViews[0] = (ImageView) view.findViewById(getID("cover0","id"));
        mImageViews[1] = (ImageView) view.findViewById(getID("cover1","id"));
		mImageViews[2] = (ImageView) view.findViewById(getID("cover2","id"));
        mImageViews[3] = (ImageView) view.findViewById(getID("cover3","id"));
